...
public class MekanismCompatibility extends ModCompatibility {
    ...
    public MekanismCompatibility() {
        movementOptions = Arrays.asList(
                ...
                new BoolOption("Gas Tank", "GasTank_movement", GasTank_movement, true),
        ...
        backgroundOptions = Arrays.asList(
                ...
                new BoolOption("Gas Tank", "GasTank_background_disable", GasTank_background_disable, true),
    ...
    public Optional<Boolean> shouldAllowMovement(Screen screen) {
        ...
        if (screen instanceof GuiGasTank) return Optional.of(GasTank_movement.get());
    ...
    public Optional<Boolean> shouldDisableBackground(Screen screen) {
        ...
        if (screen instanceof GuiGasTank) return Optional.of(GasTank_background_disable.get());
