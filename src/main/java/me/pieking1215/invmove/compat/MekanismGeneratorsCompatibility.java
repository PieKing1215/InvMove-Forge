...
public class MekanismGeneratorsCompatibility extends ModCompatibility {
    ...
    public Optional<Boolean> shouldAllowMovement(Screen screen) {
        ...
        if (screen instanceof GuiFissionReactor) return Optional.of(ReactorController_movement.get());
        if (screen instanceof GuiFissionReactorStats) return Optional.of(ReactorStats_movement.get());
        if (screen instanceof GuiFissionReactorLogicAdapter) return Optional.of(ReactorController_movement.get());
