...
//        if (screen instanceof GuiReactorController) return Optional.of(ReactorController_movement.get());
//        if (screen instanceof GuiReactorFuel) return Optional.of(ReactorFuel_movement.get());
//        if (screen instanceof GuiReactorHeat) return Optional.of(ReactorHeat_movement.get());
//        if (screen instanceof GuiReactorInfo) return Optional.of(ReactorInfo_movement.get());
//        if (screen instanceof GuiReactorLogicAdapter) return Optional.of(ReactorLogicAdapter_movement.get());
//        if (screen instanceof GuiReactorStats) return Optional.of(ReactorStats_movement.get());
...
//        if (screen instanceof GuiReactorController) return Optional.of(ReactorController_background_disable.get());
//        if (screen instanceof GuiReactorFuel) return Optional.of(ReactorFuel_background_disable.get());
//        if (screen instanceof GuiReactorHeat) return Optional.of(ReactorHeat_background_disable.get());
//        if (screen instanceof GuiReactorInfo) return Optional.of(ReactorInfo_background_disable.get());
//        if (screen instanceof GuiReactorLogicAdapter) return Optional.of(ReactorLogicAdapter_background_disable.get());
//        if (screen instanceof GuiReactorStats) return Optional.of(ReactorStats_background_disable.get());
